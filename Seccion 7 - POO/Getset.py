...
class Celular(ABC): 
    ...
    @volumen.setter #Setter
    def volumen(self, val):
        self.__volumen = val
...
celular_iphone.volumen = 10 #Cuando es utilizado getters y setters se pasa como parametro asignando como variable al objeto.
print(celular_iphone.volumen)
celular_iphone.info() #Volumen ya cambiado